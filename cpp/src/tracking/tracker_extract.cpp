...
constexpr std::size_t kLSmallToe = lift::kHalpeLeftSmallToe;
constexpr std::size_t kRSmallToe = lift::kHalpeRightSmallToe;
constexpr std::size_t kLHeel     = lift::kHalpeLeftHeel;
constexpr std::size_t kRHeel     = lift::kHalpeRightHeel;
