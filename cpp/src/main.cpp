...
void print_help() {
    std::puts(
        ...
        "  --vr-pos-mincutoff F      One Euro position at-rest cutoff Hz (default 0.8; lower=smoother)\n"
        "  --vr-pos-beta F           One Euro position motion responsiveness (default 0.4)\n"
        "  --vr-pos-dcutoff F        One Euro position speed-estimate cutoff Hz (default 1.0)\n"
        "  --vr-quat-mincutoff F     One Euro rotation at-rest cutoff Hz (default 1.0)\n"
        "  --vr-quat-beta F          One Euro rotation motion responsiveness (default 0.3)\n"
