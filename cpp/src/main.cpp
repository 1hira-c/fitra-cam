...
void print_help() {
    std::puts(
        ...
        "  --no-3d-postprocess       publish triangulator output without Kalman, IK, or floor stabilization\n"
        ...
        "  --floor-contact-exit-grace-s F require persistent exit signal (default 0.05)\n"
        ...
        "  --limb-extension-snap    enable near-straight arm/leg tracker snapping (default on)\n"
        "  --no-limb-extension-snap disable near-straight arm/leg tracker snapping\n"
        "  --extended-leg-toe-direction  enable extended thigh/shin twist from ankle->toe (default on)\n"
        "  --no-extended-leg-toe-direction  disable extended thigh/shin toe-direction inference\n"
        "  --extension-snap-enter-deg F  enter while extending below flexion (default 20)\n"
        "  --extension-snap-exit-deg F   leave while flexing above flexion (default 12)\n"
        "\n"
