...
void print_help() {
    std::puts(
        ...
        "  --limb-extension-snap    snap near-straight arm/leg tracker chains (default off)\n"
        "  --extended-leg-toe-direction  infer extended thigh/shin twist from ankle->toe (default off)\n"
